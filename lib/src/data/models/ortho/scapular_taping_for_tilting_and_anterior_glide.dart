...
part 'scapular_taping_for_tilting_and_anterior_glide.g.dart';

@JsonSerializable()
class ScapularTapingForTiltingAndAnteriorGlide extends Equatable {
  ...
  const ScapularTapingForTiltingAndAnteriorGlide({
    this.purpose,
  ...
  factory ScapularTapingForTiltingAndAnteriorGlide.fromJson(
    Map<String, dynamic> json,
  ) {
    return _$ScapularTapingForTiltingAndAnteriorGlideFromJson(json);
  }

  Map<String, dynamic> toJson() {
    return _$ScapularTapingForTiltingAndAnteriorGlideToJson(this);
  }

  ScapularTapingForTiltingAndAnteriorGlide copyWith({
    List<String>? purpose,
    ...
    return ScapularTapingForTiltingAndAnteriorGlide(
